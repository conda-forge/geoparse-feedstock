...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geoparse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14701&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geoparse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geoparse` can be installed with:

```
conda install geoparse
```

It is possible to list all of the versions of `geoparse` available on your platform with:
